...
import {
  detectGemTierChanges,
  type GemTierChange,
} from "@/lib/gems/notifications";
...
describe("detectGemTierChanges", () => {
  ...
  it("detects upgrade from quartz to amethyst (0.1 -> 0.5)", () => {
    const oldScores = new Map([
      [
        "release-1",
        { score: 0.1, title: "Test Album", discogsId: 12345 },
      ],
    ]);
    const newScores = new Map([
      [
        "release-1",
        { score: 0.5, title: "Test Album", discogsId: 12345 },
      ],
    ]);
  ...
  it("detects upgrade from sapphire to diamond (5.0 -> 7.0)", () => {
    const oldScores = new Map([
      [
        "release-2",
        { score: 5.0, title: "Rare Vinyl", discogsId: 67890 },
      ],
    ]);
    const newScores = new Map([
      [
        "release-2",
        { score: 7.0, title: "Rare Vinyl", discogsId: 67890 },
      ],
    ]);
  ...
  it("returns no change when tier stays the same (0.5 -> 0.4, both amethyst)", () => {
    const oldScores = new Map([
      [
        "release-3",
        { score: 0.5, title: "Same Tier", discogsId: 111 },
      ],
    ]);
    const newScores = new Map([
      [
        "release-3",
        { score: 0.4, title: "Same Tier", discogsId: 111 },
      ],
    ]);
  ...
  it("detects downgrade from ruby to amethyst (1.5 -> 0.5)", () => {
    const oldScores = new Map([
      [
        "release-4",
        { score: 1.5, title: "Downgraded", discogsId: 222 },
      ],
    ]);
    const newScores = new Map([
      [
        "release-4",
        { score: 0.5, title: "Downgraded", discogsId: 222 },
      ],
    ]);
  ...
  it("returns empty array for first sync (new records not in oldScores)", () => {
    ...
    const newScores = new Map([
      [
        "release-new-1",
        { score: 0.5, title: "New Record 1", discogsId: 333 },
      ],
      [
        "release-new-2",
        { score: 3.5, title: "New Record 2", discogsId: 444 },
      ],
    ]);
  ...
  it("detects multiple changes across different records", () => {
    const oldScores = new Map([
      [
        "r-1",
        { score: 0.1, title: "Album A", discogsId: 1 },
      ],
      [
        "r-2",
        { score: 5.0, title: "Album B", discogsId: 2 },
      ],
      [
        "r-3",
        { score: 0.5, title: "Album C (no change)", discogsId: 3 },
      ],
    ]);
    const newScores = new Map([
      [
        "r-1",
        { score: 1.0, title: "Album A", discogsId: 1 },
      ],
      [
        "r-2",
        { score: 7.0, title: "Album B", discogsId: 2 },
      ],
      [
        "r-3",
        { score: 0.6, title: "Album C (no change)", discogsId: 3 },
      ],
      [
        "r-new",
        { score: 10.0, title: "New Album (skip)", discogsId: 4 },
      ],
    ]);
