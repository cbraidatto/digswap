	...
	return (
		<div className="bg-surface-container rounded-lg border border-outline-variant/20 p-4 space-y-4">
			...
			<div className="flex items-center justify-between">
				<span className="font-mono text-xs text-primary tracking-[0.15em]">[SET_BUILDER]</span>
				<button
					type="button"
					onClick={onClose}
			...
			{/* Track picker */}
			{items.length === 0 ? (
				<p className="font-mono text-xs text-on-surface-variant/60">No items in this crate yet.</p>
			) : (
				<div>
					<div className="font-mono text-xs text-on-surface-variant mb-2">SELECT TRACKS</div>
			...
			{selectedItemIds.size > 0 && (
				<div>
					<div className="font-mono text-xs text-on-surface-variant mb-2">TRACK ORDER</div>
