		...
		<div>
			...
			<div className="flex items-start gap-3 mb-8">
				<div className="flex-1 min-w-0">
					<h1 className="font-heading text-2xl font-bold text-on-surface">{crate.name}</h1>
					<div className="flex items-center gap-3 mt-1.5">
						<span className={`font-mono text-xs px-1.5 py-0.5 rounded border ${chip.className}`}>
							{chip.label}
						</span>
						{displayDate && (
				...
				<CrateHeaderActions crateId={id} crateTitle={crate.name} initialIsPublic={crate.isPublic} />
			</div>
