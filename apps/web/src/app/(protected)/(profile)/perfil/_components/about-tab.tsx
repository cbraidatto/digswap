		...
		<div className="space-y-8">
			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-3">
				{[
					{
						label: "Records",
						value: stats.collectionCount.toLocaleString(),
						color: "text-primary",
					...
					<div
						key={s.label}
						className={`relative overflow-hidden bg-surface-container-low rounded-xl p-4 border border-outline-variant/5`}
					>
						<div
							className={`absolute inset-0 bg-gradient-to-br ${s.accent} to-transparent opacity-50`}
						/>
								...
								{s.label === "Score" ? (
									...
									<>
										...
										{s.value === "—" ? (
											...
											<CountUp end={Number(s.value.replace("#", ""))} prefix="" />
										)}
									</>
								) : (
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<div className="bg-surface-container-low rounded-xl p-4 border border-outline-variant/5">
					<h3 className="font-mono text-[10px] text-on-surface-variant uppercase tracking-widest mb-3">
						Trade Reputation
					</h3>
			...
			{isOwner && (
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
					...
					<div className="bg-surface-container-low rounded-xl p-5 border border-outline-variant/5 space-y-4">
						<div>
							<h3 className="font-mono text-[10px] text-on-surface-variant uppercase tracking-widest mb-2">
								Share your bounty
							</h3>
							<ShareSurface
