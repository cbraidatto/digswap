...
- **Frontend**: Codex aesthetics prompting methodology — distinctive design, retro/analog visual identity
...
- Because the "Codex aesthetics prompting" approach means generating distinctive CSS, not picking a pre-built theme
